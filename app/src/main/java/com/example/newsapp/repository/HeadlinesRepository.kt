...
internal object HeadlinesRepository {
    ...
    fun findHeadlinesFromNetwork(query: String, sortBy : String, language: NewsAPI.FilterLanguage) : LiveData<List<Article>>
    {
        val client = client
        var call = client.findHeadlines(query, sortBy, language.code)
